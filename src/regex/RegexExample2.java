...
public class RegexExample2 {
    public static void main(String[] args) {
        Pattern pattern = Pattern.compile("skręć w (prawo|lewo)"); // nawiasy ograniczają zakres stosowalności alternatywy i jest wybór
                                                                        // prawo lub lewo, a nie np. "skręć w prawo" ALBO "lewo"
        Matcher matcher = pattern.matcher("skręć w prawo");
        Matcher matcher2 = pattern.matcher("skręć w lewo");
        Matcher matcher3 = pattern.matcher("skręć w górę");
